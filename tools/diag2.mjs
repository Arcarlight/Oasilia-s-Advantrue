...
child.stderr.on('data', (d) => {
  buf += d.toString('utf8');
  if (realtime && /BGM_DONE|D2_DONE|DIAG_DONE|EV_DONE|REST_DONE|FX_DONE|SHIELD_DONE|INTENT_DONE|DMG_DONE|CARD_DONE|FLOAT_DONE|LOOP_DONE|DODGE_DONE|STUCK_DONE|TURNART_DONE/.test(buf)) {
