...
export const BALANCE = {
  ...
  // ============================================================
  enemyHp: {
    mob: [236, 443, 738, 1033, 1180, 1455],
    normal: [251, 668, 788, 1328, 1475, 1519],
    elite: [201, 547, 730, 1080, 1307, 1499],
    boss: [155, 386, 543, 787, 982, 1158],
  },
  enemyAtk: {
    mob: [6, 8, 11, 13, 15, 18],
    normal: [7, 8, 11, 14, 16, 19],
    elite: [10, 11, 15, 20, 23, 26],
    boss: [12, 15, 21, 26, 30, 31],
  },
