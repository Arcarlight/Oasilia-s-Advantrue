...
export const BALANCE = {
   ...
   */
  targetTurns: { mob: 2.0, normal: 2.5, elite: 3.5, boss: 4.5 },

  // 索引 = 章节（0~5）；数值 = 该章「中段节点」的基础值，再乘章内深度与玩家战力对齐系数
  enemyHp: {
    mob: [46, 143, 225, 341, 417, 451],
    normal: [66, 204, 322, 487, 596, 644],
    elite: [50, 228, 375, 383, 692, 820],
    boss: [60, 317, 415, 418, 905, 1083],
  },
  enemyAtk: {
    mob: [7, 17, 26, 52, 54, 56],
    normal: [16, 40, 61, 120, 124, 128],
    elite: [20, 21, 22, 58, 71, 78],
    boss: [6, 13, 24, 25, 55, 62],
  },
